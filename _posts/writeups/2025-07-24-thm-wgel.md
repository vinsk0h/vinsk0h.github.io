...
description: "Writeup for the WGEL CTF room on TryHackMe — enumeration, SSH key discovery via hidden directory, and privilege escalation through wget SUDO."
image:
  path: https://cdn.hashnode.com/res/hashnode/image/upload/v1667861213814/MWfKWU2kh.png
  alt: WGEL CTF TryHackMe
pin: false
toc: true
comments: true
---
